...
func InitOptionMap() {
	...
	common.OptionMap["RechargePremium"] = strconv.FormatFloat(operation_setting.RechargePremium, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "RechargePremium":
		operation_setting.RechargePremium, _ = strconv.ParseFloat(value, 64)
	case "MinTopUp":
